            ...
            <ul className="space-y-3">
              ...
              {member.contact.github && (
                <li className="flex items-center gap-3 group">
                  ...
                  <a href={`https://${member.contact.github}`} target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-primary transition-colors">GitHub</a>
                </li>
              )}
              {member.contact.portfolio && (
                <li className="flex items-center gap-3 group">
                  ...
                  <a href={`https://${member.contact.portfolio}`} target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-primary transition-colors">Portfolio</a>
                </li>
              )}
              {member.contact.personal && (
                <li className="flex items-center gap-3 group">
                  ...
                  <a href={`https://${member.contact.personal}`} target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-primary transition-colors">Website</a>
                </li>
              )}
            </ul>
          </div>
