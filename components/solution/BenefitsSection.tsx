      ...
      <div className="container px-4 md:px-6 mx-auto">
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end gap-6 mb-12 md:mb-16">
          <div className="max-w-2xl">
            ...
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-charcoal leading-tight">Enterprise Benefits Solutions</h2>
            <p className="text-slate mt-4 text-lg max-w-xl">
              Learn how Sanicle.cloud transforms your workplace, providing tangible practical benefits for your organization.
            </p>
          </div>
          <div className="mt-2">
            <Button variant="outline" className="border-primary text-primary hover:bg-primary-pale px-5 py-2.5 rounded-lg transition-all group flex items-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          <div className="relative group">
            <div className="absolute inset-0 bg-gradient-to-br from-primary-pale to-primary/5 rounded-xl transform group-hover:scale-[1.03] transition-transform duration-300 opacity-0 group-hover:opacity-100"></div>
            <div className="relative z-10 p-6 sm:p-8 border border-gray-100 rounded-xl bg-white shadow-sm hover:shadow-md transition-all duration-300">
              <div className="w-16 h-16 rounded-full bg-primary-pale flex items-center justify-center mb-6 shadow-inner">
                <Users className="h-8 w-8 text-primary" />
              </div>
              <h3 className="text-xl font-bold text-charcoal mb-4">Attract and Retain Talent</h3>
                ...
                {["Reduce turnover costs", "Attract diverse talent", "Increase employee satisfaction"].map(
                  (item, i) => (
                    <div key={i} className="flex items-start group/item">
                      ...
                      <span className="text-charcoal group-hover/item:text-secondary transition-colors">{item}</span>
                    </div>
                  ),
                )}
              </div>
          ...
          <div className="relative group md:mt-8 lg:mt-12">
            ...
            <div className="relative z-10 p-6 sm:p-8 border border-gray-100 rounded-xl bg-white shadow-sm hover:shadow-md transition-all duration-300">
              ...
              <h3 className="text-xl font-bold text-charcoal mb-4">Improve Productivity</h3>
              <p className="text-slate mb-6">
          ...
          <div className="relative group md:mt-16 lg:mt-24">
            ...
            <div className="relative z-10 p-6 sm:p-8 border border-gray-100 rounded-xl bg-white shadow-sm hover:shadow-md transition-all duration-300">
              ...
              <h3 className="text-xl font-bold text-charcoal mb-4">Easy Implementation</h3>
              <p className="text-slate mb-6">
